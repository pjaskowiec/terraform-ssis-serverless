class Course():
    ...
    @staticmethod
    def get_coursecodes(cursor) -> list:
        query = '''
            SELECT code
            FROM course
        '''
    ...
    @staticmethod
    def get_coursecode_for(cursor, course_name: str = None) -> str:
        print(course_name)
        query = f'''
                SELECT code
                FROM course
    ...
    @staticmethod
    def delete(cursor, code: str = None) -> None:
        query = f'''
            DELETE FROM course
            WHERE code='{code}'
        '''
    ...
    @staticmethod
    def get_collegecode(cursor, course_name: str = None) -> str:
        query = f'''
